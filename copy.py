    ...
    while True:  #Loop for returning to the main menu
        ...
        if ask == "1":
            ...
            while True:  #Conditional statements submenu
                ...
                if ask_subMenu4 == "1":
                    print(f"""\nAnnyeong! {askName} , Welcome to the CONDITIONAL STATEMENT of Python\n""") #Definition
                    Explain4()
                    menu4()
                elif ask_subMenu4 == "2":
                    print(f"""\nAnnyeong! {askName} , Welcome to the CONDITIONAL STATEMENT of Python""") #Example4
                    condiStat()
            ...
            while True:  #Loop statements submenu
                ...
                if ask_subMenu5 == "1":
                    print(f"""\nAnnyeong! {askName} , Welcome to the LOOPING STATEMENT of Python""")  #looping example
                    EX5()
                    menu5()
                elif ask_subMenu5 == "2":
                    print(f"""\nAnnyeong! {askName} , Welcome to the LOOPING STATEMENT of Python""")
                    Loops()
                    menu5()
                    continue
                elif ask_subMenu5 == "3":
            ...
            while True:  #Lists submenu
                ...
                if ask_subMenu6 == "1":
                    print(f"""\nAnnyeong! {askName} , Welcome to the LISTS of Python""")  #Definition and example
                    Explain6()
                    menu6()
                elif ask_subMenu6 == "2":
                    print(f"""\nAnnyeong! {askName} , Welcome to the LISTS of Python""")  #A program output of lists
                    Lists()
                    menu6()
                    continue
                elif ask_subMenu6 == "0":
